...
"#+TITLE: %<%A, %-m/%-d/%y>
#+STARTUP: overview\n\n
")))) ; On vacsation don't look at work.
...
;; \* TODO [[elisp:(gh/open-or-pop-to-agenda)][Agenda]]
...
Files to include in agenda are set in =my/global/functions.el=. Currently only =./pages= and =./daily=.
